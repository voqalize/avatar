...
const identities = [
  {
    ...
    persona: {
      ...
      skin: [31, 0.34, 0.72],
      iris: commonIris,
      brow: { weight: 1.18, colour: [20, 0.26, 0.16] },
      lash: { weight: 0 },
      eye: {
        aperture: 0.84,
        irisScale: 1.07,
        finish: {
          sclera: [246, 243, 239, 1], scleraShade: [238, 234, 230, 1],
          shadeAlpha: 0.13, limbalAlpha: 0.15, glowAlpha: 0.08,
          catchAlpha: 0.7, catch2Alpha: 0, waterAlpha: 0.16,
          catch: { r: 0.17, r2: 0.05 },
        },
        refine: { lidFoldDepth: 11, lidFoldAlpha: 0.72, creaseDepth: 3, brow: { head: 0.85, peak: 0.93, tail: 0.9 } },
      },
      mouth: { philtrum: { a: 0.5, w: 13 }, lipHiAlpha: 0.58, bowAlpha: 0.58, seamAlpha: 0.86, commissAlpha: 0.72 },
      form: { socket: true, socketAlpha: 0.09, sideShadeAlpha: 0.15 },
      nose: { style: 'mature', bridge: 0.98, base: 0.94, nostril: 0.84, shadow: 0.74 },
  ...
  },
  {
    ...
    persona: {
      ...
      eye: {
        ...
        finish: {
          sclera: [246, 243, 239, 1], scleraShade: [238, 234, 230, 1],
          shadeAlpha: 0.13, limbalAlpha: 0.14, glowAlpha: 0.08,
          catchAlpha: 0.7, catch2Alpha: 0, waterAlpha: 0.16,
          catch: { r: 0.17, r2: 0.05 },
        },
        refine: { lidFoldDepth: 11, lidFoldAlpha: 0.72, creaseDepth: 3, brow: { head: 0.92, peak: 0.97, tail: 0.94 } },
      },
      mouth: { philtrum: { a: 0.42, w: 11.5 }, lipHiAlpha: 0.58, bowAlpha: 0.58, seamAlpha: 0.84, commissAlpha: 0.7 },
      form: { socket: true, socketAlpha: 0.085, sideShadeAlpha: 0.15 },
      nose: { style: 'mature', bridge: 0.87, base: 0.88, nostril: 0.74, shadow: 0.66 },
