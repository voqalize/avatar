...
const identities = [
  ...
  },
  {
    ...
    persona: {
      ...
      brow: { weight: 0.96, colour: [19, 0.27, 0.18] },
      lash: { weight: 0.66 },
      eye: {
        aperture: 0.77,
        irisScale: 1.12,
      ...
      mouth: { philtrum: { a: 0.4, w: 11.5 }, lipHiAlpha: 0.48, bowAlpha: 0.46, lipCastAlpha: 0.78, seamAlpha: 0.7, commissAlpha: 0.55 },
      form: { socket: true, socketAlpha: 0.115, socketDepth: 1.4, sideShadeAlpha: 0.175, sideShadeWidth: 1.3 },
      nose: { style: 'mature', bridge: 1.02, base: 0.95, nostril: 0.74, shadow: 0.94 },
