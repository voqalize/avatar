...
and TTS are `apps/server/canned.py`: a fixed corpus of sentences with a WAV recorded
...
async def run_bot(
    ...
    logger.info("corpus: {} lines from {}, voice {}", len(lines), LINES.name, lines.voice.name)
